...
<?php ig_page_header_portfolio($post->ID); ?>
                    ...
                    <div class="ig-social-share single-post">
                        <div class="navigation-controls">
                            <ul>
                                ...
                                if( !empty($options['portfolio-index']) ) { ?>
									<li class="port-index"><a href="<?php echo $options['portfolio-index'] ?>" rel="index"><i class="icon-layers2"></i>'.__('Portfolio Index', 'INFINITE_LANGUAGE').'') ?></a></li>
								<?php } ?>
