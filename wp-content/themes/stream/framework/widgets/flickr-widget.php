...
class Quick_Flickr_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct( 
			'quick-flickr-widget', 
			__('Quick Flickr Widget', INFINITE_LANGUAGE), array(
			'description' => __('Display up to 20 of your latest Flickr submissions in your sidebar.', INFINITE_LANGUAGE)
		) );
	}
	...
	private function get_photos( $args = array() ) {
		...
		if ( ! $photos )
			return new WP_Error( 'error', __('Could not fetch photos.', INFINITE_LANGUAGE) );
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php _e( 'Username or RSS:', INFINITE_LANGUAGE); ?></label> 
			<input class="widefat" id="<?php echo $this->get_field_id( 'username' ); ?>" name="<?php echo $this->get_field_name( 'username' ); ?>" type="text" value="<?php echo esc_attr( $username ); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'tags' ); ?>"><?php _e( 'Tags:', INFINITE_LANGUAGE); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e( 'Count:', INFINITE_LANGUAGE); ?></label><br />
