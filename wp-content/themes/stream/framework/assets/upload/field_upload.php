...
class Redux_Options_upload {
    ...
    */
    function render() {
        ...
        echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload button-secondary"' . $upload . ' rel-id="' . $this->field['id'] . '">' . __('Upload', INFINITE_LANGUAGE) . '</a>';
        echo ' <a href="javascript:void(0);" class="redux-opts-upload-remove"' . $remove . ' rel-id="' . $this->field['id'] . '">' . __('Remove Upload', INFINITE_LANGUAGE) . '</a>';
    ...
    */
    ...
    //         global $wp_version; //AP: why doesn't this work?!?!
        ...
        wp_localize_script('redux-opts-field-upload-js', 'redux_upload', array('url' => $this->url.'assets/upload/blank.png'));
    }
}
