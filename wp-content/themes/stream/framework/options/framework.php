...
//                $comparison = $field['required'][1];
        ...
        function _admin_bar_menu() {
            ...
            if($menu){
                ...
                $nodeargs = array(
                    ...
                    'title' => "<span class='ab-icon dashicons-admin-generic'></span>" . $theme_data->get('Name') . " " . __('Options', 'INFINITE_LANGUAGE'),
        ...
        public function _load_page() {
            ...
            if (true == $this->show_hints) {
                ...
                $tab = array (
                    'id'        => 'redux-hint-tab',
                    'title'     => __('Hints', 'INFINITE_LANGUAGE'),
                    'content'   => __('<p>' . $msg . '</p>', 'INFINITE_LANGUAGE')
                );
        ...
        public function _options_page_html() {
            ...
            echo '<div id="redux-header">';
                ...
                echo '<a href="https://visualmodo.com/" target="_blank"><img alt="Visualmodo" src="'.get_template_directory_uri().'/includes/img/visualmodo.png"></a>';
                echo '</div>';
				
				echo '<div class="redux-action_bar infinitegrids-custom-menu">';
				echo '<a href="https://visualmodo.com/store/" target="_blank"><i class="icon-bag3"></i>Store</a>';
				echo '<a href="https://visualmodo.com/free/" target="_blank"><i class="icon-heart9"></i>Free Resources</a>';
				echo '<a href="https://visualmodo.com/blog/" target="_blank"><i class="icon-pencil6"></i>Blog</a>';
                echo '<a href="https://visualmodo.com/help/" target="_blank"><i class="icon-help2"></i>Help Center</a>';
				echo '<a href="https://visualmodo.com/documentation/" target="_blank"><i class="icon-book3"></i>Documentation</a>';
                echo '</div>';
