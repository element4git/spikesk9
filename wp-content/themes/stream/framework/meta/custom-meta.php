...
if ($current_post_id != 'portfolio' || $current_post_id != 'knowledgebase' || $current_post_id != 'team' || $current_post_id != 'page' || $current_post_id != 'post') {
add_action('add_meta_boxes', 'ig_metabox_custom_page');

function ig_metabox_custom_page(){
...
if (($exclude_menu = array_search('Primary Side Menu', $locations)) !== false) {
    ...
    $meta_box = array(
		...
		'title' => __('Docs Header Settings', INFINITE_LANGUAGE),
