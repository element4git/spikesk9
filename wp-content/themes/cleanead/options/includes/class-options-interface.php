...
class Cleanead_Options_Framework_Interface {
	...
	static function optionsframework_fields() {
		...
		foreach ( $options as $value ) {
			...
			// Uploader
			case "upload":
				$output .= Cleanead_Options_Framework_Media_Uploader::optionsframework_uploader( $value['id'], $val, null );
			...
			case 'typography':
				...
				$typography_options = array(
					'sizes' => cleanead_recognized_font_sizes(),
					'faces' => cleanead_recognized_font_faces(),
					'styles' => cleanead_recognized_font_styles(),
					'color' => true
				);
				...
				$typography_fields = apply_filters( 'cleanead_typography_fields', $typography_fields, $typography_stored, $option_name, $value );
			...
			case 'background':
				...
				$output .= Cleanead_Options_Framework_Media_Uploader::optionsframework_uploader( $value['id'], $background['image'], null, esc_attr( $option_name . '[' . $value['id'] . '][image]' ) );
				...
				$repeats = cleanead_recognized_background_repeat();
				...
				$positions = cleanead_recognized_background_position();
				...
				$attachments = cleanead_recognized_background_attachment();
		...
		if ( Cleanead_Options_Framework_Interface::optionsframework_tabs() != '' ) {
			echo '</div>';
		}
	}
